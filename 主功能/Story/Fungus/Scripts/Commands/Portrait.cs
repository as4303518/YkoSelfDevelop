...
namespace Fungus
{
    ...
    public class Portrait : ControlWithDisplay<DisplayType>
    {
        ...
        [SerializeField] protected Character character;//當下出現的角色
        ...
        [SerializeField] protected bool shiftIntoPlace;//偵測是否為指定位置,還是位移
        ...
        public override void OnEnter()//執行內容
        {
          ...
          //  stage.RunPortraitCommand(options, Continue);//執行關於角色肖像的部分
