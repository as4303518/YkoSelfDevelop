...
namespace Fungus
{
    ...
    public class Write : Command, ILocalizable
    {
      ...
      /*      if (!waitUntilFinished)
            {
                Sayinfo sayinfo=new Sayinfo(newText, clearText, false, true,true, false, Say.MouthAnimation.DidNotPlay, null, null,null);
            ...
            {
                Sayinfo sayinfo = new Sayinfo(newText, clearText, false, true, true, false, Say.MouthAnimation.DidNotPlay, null,null, () => { Continue(); });
