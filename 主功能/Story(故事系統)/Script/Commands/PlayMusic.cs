...
namespace Fungus
{
    ...
    public class PlayMusic : Command
    {
        ...
        public override void OnEnter()
        {
            ...
            var settingVolume = PlayerPrefs.GetFloat(Enum.GetName(typeof(SoundType), SoundType.BGM), 1.0f);
            musicManager.PlayMusic(musicClip, loop, fadeDuration, startTime,settingVolume);
