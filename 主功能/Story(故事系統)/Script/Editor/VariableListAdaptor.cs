...
namespace Fungus.EditorUtils
{
    public class VariableListAdaptor
    {
        ...
        private void AddDropDown(Rect buttonRect, ReorderableList list)//顯示值類型下拉選單
        {
            Event.current.Use();
        ...
        public void DrawVarList(int value)
        {
            ...
            try
            {
                ...
                this.widthOfList = (value == 0 ? VariableListAdaptor.DefaultWidth : value) - ScrollSpacer;
                ...
                if (GUILayout.Button("Variables"))//擴展button的按鈕
                {
        ...
        private void DoRightClickMenu(int index)//對數值選向點擊右鑑
        {
            ...
            commandMenu.ShowAsContext();//展示出右鑑選項
        }
