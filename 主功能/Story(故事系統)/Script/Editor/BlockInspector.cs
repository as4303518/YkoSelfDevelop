...
namespace Fungus.EditorUtils
{
    ...
    public class BlockInspectorEditor : Editor 
    {
        ...
        public override void OnInspectorGUI () //點選block顯示的 inspertorGUI 主方法在blockEdirot
        {
            ...
            if (activeBlockEditor == null ||!block.Equals(activeBlockEditor.target))
            {
        ...
        private void ResizeScrollView(Flowchart flowchart)
        {
            ...
            ClampBlockViewHeight(flowchart);//控制視窗最高與最低
